...
const AdvisoryBoard: React.FC = () => {
  ...
  const handleViewAll = () => setShowAll(!showAll);

  return (
    <section className="my-24 px-8">
      <div className="relative overflow-hidden max-w-[1320px] mx-auto bg-[#165620] text-[#FBEADC] py-16 px-4">
        <div
        ...
        <div className="relative z-10 max-w-6xl mx-auto flex flex-col">
          <h2 className="text-4xl md:text-5xl lg:text-6xl text-[#FBEADC] text-center font-medium leading-tight uppercase mb-8">
            Advisory Board
          </h2>
          ...
          <button
            ...
            type="button"
            title="View All Advisory Board Members"
          >
            View All
            <FiArrowRight />
          </button>
